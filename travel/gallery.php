...
<!-- GALLERY PHP -->
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 mb20">
                        <div class="gallery-img"> <a href="images/gallery_big_1.jpg" class="image-link imghover" title="gallery zoom image"><img src="gallery_image/<?php  echo $row['image']; ?>" alt="" class="img-fluid"></a></div>
                    </div>
                    <?php   
                        }
                    }
